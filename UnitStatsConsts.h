...
static const std::string MINE_AND_OBSTACLE_FILE_COULDNT_OPEN = "Private map and obstacle file could not open, path: ";

//Local file path
static const std::string MINE_AND_OBSTACLE_FILE = "player.txt";
